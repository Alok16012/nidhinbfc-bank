      ...
      <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input className={inputClass} value={form.guarantor_name} onChange={(e) => handleChange("guarantor_name", e.target.value)} placeholder="Optional" />
          </div>
          <div>
            <label className={labelClass}>Guarantor Phone</label>
            <input className={inputClass} value={form.guarantor_phone} onChange={(e) => handleChange("guarantor_phone", e.target.value)} placeholder="Optional" />
          </div>
          <div className="md:col-span-2">
